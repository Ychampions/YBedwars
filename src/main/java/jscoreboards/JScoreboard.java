package jscoreboards;

import jscoreboards.abstraction.InternalObjectiveWrapper;
import jscoreboards.abstraction.InternalTeamWrapper;
import jscoreboards.exception.DuplicateTeamCreatedException;
import jscoreboards.exception.ScoreboardLineTooLongException;
import jscoreboards.exception.ScoreboardTeamNameTooLongException;
import jscoreboards.versioning.SpigotAPIVersion;
...
public abstract class JScoreboard {
  ...
  protected void updateScoreboard(Scoreboard scoreboard, List<String> lines) throws ScoreboardLineTooLongException {
    ...
    for (String entry : reversedLines) {
      ...
      int cutoff = SpigotAPIVersion.getCurrent().lessThan(SpigotAPIVersion.v1_11) ? 16 : 64;
